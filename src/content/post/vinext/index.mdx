...
<Image src={vinextBuildClient} format="webp" alt="Comparativo de build e client-side entre Next.js e Vinext" />
...
<Image src={vinextBuildServer} format="webp" alt="Comparativo de chunks server-side entre Next.js e Vinext" />
